...
while True:
    ...
    # Frame Skipping: Process every 2nd frame to reduce computation load
    if count % 2 != 0:
        continue
        ...
        if id in up:
           ...
           if red_line_y<(cy+offset) and red_line_y > (cy-offset):
             ...
             if counter_up.count(id)==0:
                ...
                distance1 = 1000 # meters  (Distance between the 2 lines is 10 meters )
