...
while True:
    ...
    cv2.rectangle(frame, (0, 0), (350, 90), yellow_color, -1)
    cv2.putText(frame, ("Date & Time : "), (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, text_color, 1, cv2.LINE_AA)
    cv2.putText(frame, current_datetime, (130, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1, cv2.LINE_AA)



    cv2.putText(frame, ("Location : "), (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.5, text_color, 1, cv2.LINE_AA)
    cv2.putText(frame, ("SG Highway"), (130, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.5, text_color, 1, cv2.LINE_AA)

    


    cv2.line(frame, (172, 150), (900, 150), yellow_color, 2)
    cv2.putText(frame, ('Yellow Line'), (172, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.5, text_color, 1, cv2.LINE_AA)
    

    cv2.line(frame, (100, 268), (1000, 268), blue_color, 2)
    cv2.putText(frame, ('Blue Line'), (100, 268), cv2.FONT_HERSHEY_SIMPLEX, 0.5, text_color, 1, cv2.LINE_AA)
